...
import pixelrealm.graphics.GameGraphics;
...
import pixelrealm.states.LostActivity;
import pixelrealm.states.PauseActivity;
...
public class GameSurface extends SurfaceView implements SurfaceHolder.Callback {
	...
	public void doDraw(Canvas canvas) {
		...
		GameGraphics.desenharEntidades(_context.getAssets(),getJogo(), canvas, paint);
